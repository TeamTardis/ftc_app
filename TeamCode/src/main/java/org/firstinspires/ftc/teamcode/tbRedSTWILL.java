...
@Autonomous(name = "RED", group = "AutoFast")
public class tbRedSTWILL extends LinearOpMode { // tb = TestBed
    DcMotor m1;
    DcMotor m2;
    DcMotor m3;
    DcMotor m4;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while (runtime.seconds() < .5) {
            ...
            m5.setMaxSpeed(1050);  //Set max speed for shooter
            m6.setMaxSpeed(1050);  //943 (-9)
            //Shooter Start
            m5.setPower(-.1);
            m6.setPower(.1);
            m7.setPower(-1);
        ...
        runtime.reset();
        while (gyro.getIntegratedZValue() > -40) {
            m1.setPower(.1); //Turn 35 degrees
            m2.setPower(-.1);
            m3.setPower(.1);
            m4.setPower(-.1);
            idle();
        ...
        runtime.reset();
        while (gyro.getIntegratedZValue() < -5) {
            m1.setPower(-.1);
            m2.setPower(.1);
            m3.setPower(-.1);
            m4.setPower(.1);
        ...
        while (runtime.seconds() < 0.7) {
            m1.setPower(-.3); //Tilt slightly and retur to wall
            m2.setPower(.3);
            m3.setPower(.3);
            m4.setPower(-.3);
            idle();
        ...
        while (odsSensor1.getRawLightDetected() < .3) {
            if (gyro.getHeading() != 0 && gyro.getIntegratedZValue() < 0) {
                m1.setPower(.5);
                m2.setPower(0);
                m3.setPower(0);
                m4.setPower(1);
