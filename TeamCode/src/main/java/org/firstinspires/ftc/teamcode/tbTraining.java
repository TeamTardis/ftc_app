...
import static org.firstinspires.ftc.teamcode.tbTraining.steps.NORMAL_DRIVE;
...
@Disabled
public class tbTraining extends OpMode {
        ...
        switch (CURRENT_STEP) {
            ...
            case NORMAL_DRIVE:
                ...
                if (gamepad1.right_trigger == 0) {
                    ...
                    if (h > 0 && h < 45) {
                        //Controls for Left Stick
                        m1.setPower((LRL + LUD - h45) / 2);   //Motor1 is x-axis plus y-axis
                        m2.setPower((LUD - LRL - h45) / 2);   //Motor2 is x-axis minus y-axis
                        m3.setPower((LUD - LRL - h45) / 2);   //Motor3 is x-axis minus y axis(parallel to M2)
                        m4.setPower((LRL + LUD - h45) / 2);   //Motor4 is x-axis plus y-axis(parallel to M1)
                        break;
                    }
