...
@Autonomous(name = "BLUE_ONE_BALL", group = "AutoFast") //Display name and group found in on controller phone
public class Blue_FULL_ONE_BALL extends TardisOpModeAutonomous { //Imports presets for initiation from TardisOpModeAutonomous
